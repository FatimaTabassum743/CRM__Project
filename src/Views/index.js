...
import DashboardCards from "./Postlogin/Dashboard";
import CustomerDetails from "./Postlogin/Customers/CustomerDetails";
...
const CustomersDetails = lazy(() => import("./Postlogin/Customers/CustomerDetails"));
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <Routes>
          ...
          />
            <Route
            exact
            path={`${PREFIX_APP_PATH}/customerDetails`}
